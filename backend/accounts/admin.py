...
class Statistics(models.Model):
    ...
    name = models.CharField(max_length=100, default="Статистика сайта")
...
class StatisticsAdmin(admin.ModelAdmin):
    ...
    def changelist_view(self, request, extra_context=None):
        ...
        active_users = User.objects.annotate(
            thread_count=Count('threads', filter=Q(threads__created_at__gte=seven_days_ago)),
            comment_count=Count('comments', filter=Q(comments__created_at__gte=seven_days_ago))
        ).filter(
