...
DEBUG = True
ALLOWED_HOSTS = ['*']  # Для разработки, укажите конкретные хосты в продакшене
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        'OPTIONS': {
            'min_length': 8,  # Увеличено для безопасности
        }
    },
    {
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': [
        ...
        'rest_framework.renderers.BrowsableAPIRenderer',  # Только для DEBUG
    ],
